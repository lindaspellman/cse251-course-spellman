...
if __name__ == '__main__':
    ...
    # TODO 3) change the program to divide the for loop into 10 threads
        ### Work on how to balance using any range_count using n threads!!!
    start = 10000000000
    range_count = 100000
    ...
    for i in range(10):
        ...
        t = threading.Thread(target=thread_loop, args=(thread_start, thread_end))
        threads.append(t)
